...
<div class="col-lg-12">
        ...
        <div id="" class="body">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" id="text1" disabled placeholder value="<?php echo $row['a_name'] ?>"class="form-control" name="aname">
                    </div>
                </div>
                  <!-- /.form-group -->
 <div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-lg-4">
        <input type="text" class="form-control" value="<?php echo $row['dept_name']?>" disabled />
    ...
    <div class="col-lg-4" id="txtHint">
        <select class="form-control" name="avenue" disabled>
            <option value="<?php echo $row['v_id'] ?>" required pattern="select"><?php echo $row['dept_name'] ?></option>
                ...
                <!-- /.form-group -->
                 <div class="form-group">
                    ...
                    <div class="col-lg-4">
                       <img  class="media-object user-img pull-right" alt="Amenity Picture" 
