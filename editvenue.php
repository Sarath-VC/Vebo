             ...
             <!-- /.toolbar -->
                ...
                <!-- /.form-group -->
                                ...
                                <div class="col-lg-3">
                                  ...
                                  name="vdimen" > <?php echo $row['v_description'] ?></textarea>
                                </div>
                                </div>
                    ...
                    if(isset($_POST["btns"]))
                        {
                            ...
                            $sql="update venue set v_name='$_POST[vname]',v_type='$_POST[vtype]',dept_id='$_POST[vdep]',v_description='$_POST[vdimen]',v_capacity='$_POST[vcap]',v_image='{$conmv}',v_frontimage='{$confv}',v_audienceimage='{$conav}' where v_id=$u";
