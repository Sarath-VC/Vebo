...
<![endif]-->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        $sql="select * from department where dept_id=$u";
...
<div class="col-lg-12">
    <div class="box dark">
       <header>
            <div class="icons"><i class="">DEPARTMENT DELETION</i></div>
            <h5><!-- .toolbar -->            </h5>
             <div class="icons pull-right"><a href="depmanage.php"><i class="glyphicon glyphicon-share-alt"> BACK</i></a></div>  <!-- /.toolbar -->
        </header>
        <div id="" class="body">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="dep" required placeholder="Department name" class="form-control" value="<?php echo $row['dept_name'] ?>">
                    </div>
                </div>
...
<button class="btn btn-primary " name="depreg" type="submit" onclick="return confirm('Are you sure want to confirm your deletion !') ">DELETE</button>
<button class="btn btn-primary pull-right " type="submit" onclick="disca();">DISCARD</button>
 ...
 <?php
               if(isset($_POST['depreg']))
               {
                ...
                $sql="update department set dflag=0 where dept_id=$u";
                ...
                ?>
<script type="text/javascript">alert("Successfully Deleted");
...
mysql_close();
 ...
 <?php } ?>  <script> function disca(){ window.location.assign("http://localhost/vebo/depmanage.php"); } </script>
