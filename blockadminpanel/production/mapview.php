...
<html lang="en">
  <head>
    ...
    <link href="../vendors/cropper/map/cropper.min.css" rel="stylesheet">
  </head>
 ...
 <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="background-color:#e2e4ec;">
      <div class="x_panel">
              <div class="x_title" style="background-color:#2e2e33; color:white; font-family:Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif">
                    <h2><i class="glyphicon glyphicon-map-marker"></i>    LATITUDE  </h2>
    ...
    <!-- Cropper -->
    <script src="../vendors/cropper/map/cropper.min.js"></script>
