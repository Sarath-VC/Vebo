  ...
  <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="background-color:#e2e4ec;">
                <div class="x_panel">
                    ...
                    <h2><i class="fa fa-desktop"></i> AMENITIES</h2>
                   ...
                   <!--VENUE GRID VIEW FIELDS-->
                     ...
                     $sql="select * from aminities where aflag=1"; 
                        ...
                        <div class="thumbnail">
                            <div class="image view view-first">
                                ...
                                <div class="mask">
                                    ...
                                    <a href="generalamenity.php?aid=<?php echo $row['a_id']; ?>"><i class="fa fa-desktop"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="caption">
