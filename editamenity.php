...
<div class="col-lg-12">
        ...
        <div id="" class="body">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" id="text1" required placeholder value="<?php echo $row['a_name'] ?>"class="form-control" name="aname">
                    </div>
                </div>
                  <!-- /.form-group -->
 <div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-lg-4">
        <select class="form-control" name="adep" id="adep" onchange="showUser(this.value)">
    ...
    <div class="col-lg-4" id="txtHint">
        <select class="form-control" name="avenue">
           <?php 
           include('connection.php');
        $sqlv="select * from aminities join venue on a_id=$u and aminities.v_id=venue.v_id";
        $resv=mysql_query($sqlv,$con);
        while($rowv=mysql_fetch_assoc($resv)){ ?>
            <option  value="<?php echo $rowv['v_id'] ?>" required pattern="select"><?php echo $rowv['v_name'] ?></option><?php } ?>
            <option value="" required pattern="select"></option>
        </select>
    </div>
</div>    
            ...
            src="data:image/jpeg; base64,<?php echo base64_encode($row['a_image']); ?>" width="132" height="170"/>
                    ...
                    <div class="col-lg-4">
                        <input type="file" accept="image/*" required value="" class="form-control" name="aimg">
                    </div>
                </div>
                <!-- /.form-group -->
...
<button class="btn btn-primary "  type="submit" name="btnp">UPDATE</button>
                    ...
                    if(isset($_POST["btnp"]))
                        {
                            ...
                            $sql="update aminities set a_name='$_POST[aname]',a_type='$_POST[atype]',dept_id='$_POST[adep]',a_image='{$conam}',v_id='$_POST[avenue]' where a_id=$u";
