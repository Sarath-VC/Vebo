...
<div class="col-lg-12">
	...
	$row2=mysql_fetch_assoc($res2);
        ...
        <div id="" class="body">
            ...
            <img  class="media-object user-img pull-right" alt="User Picture" 
            src="data:image/jpeg; base64,<?php  if($row['user_type']=="BA"||$row['user_type']=="FAC"||$row['user_type']=="EC")
    echo base64_encode($row1['exe_image']); else echo base64_encode($row2['stud_image']); ?>" width="132" height="170"/><div class="col-lg-12 "></div>
                </div><!-- /.form-group -->
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Name</label>

                    <div class="col-lg-2">
                        <input type="text" id="text1" disabled class="form-control"
                        value="<?php if($row['user_type']=="BA"||$row['user_type']=="FAC"||$row['user_type']=="EC")
	echo $row1['exe_fname']; else echo $row2['stud_fname']; ?>" name="fname">
                    </div>
                    <div class="col-lg-2">
                        <input type="text" id="text2" disabled class="form-control" value="<?php if($row['user_type']=="BA"||$row['user_type']=="FAC"||$row['user_type']=="EC")
	echo $row1['exe_lname']; else echo $row2['stud_lname']; ?>" name="lname">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-lg-4">
                        <input type="text" id="usename" name="user" placeholder="" disabled class="form-control" value="<?php echo $row['user_name'];  ?>">
                    </div>
                </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <select id="dept" disabled class="form-control" name="dep"><option  value="<?php if($ut=="BA"||$ut=="FAC"||$ut=="EC") echo $row1['dept_id']; else echo $row2['dept_id']; ?>" required><?php  if($ut=="BA"||$ut=="FAC"||$ut=="EC")
         ...
         <?php } ?>
                  ...
                  <!-- /.form-group -->
                     <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="date" id="date2" disabled class="form-control" value="<?php if($ut=="BA"||$ut=="FAC"||$ut=="EC")
	     ...
	     $g=$row1['exe_gender']; else $g=$row2['stud_gender'];
                ...
                <!-- /.form-group -->
                 <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <textarea id="autosize" disabled class="form-control" name="add"><?php if($ut=="BA"||$ut=="FAC"||$ut=="EC")
    {echo $row1['exe_address'];} else {echo $row2['stud_address'];} ?></textarea>
                ...
                <!-- /.form-group -->
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" id="email" placeholder="Email" disabled class="form-control" value="<?php if($ut=="BA"||$ut=="FAC"||$ut=="EC")
	echo $row1['exe_email']; else echo $row2['stud_email']; ?>" name="email">
                ...
                <!-- /.form-group -->
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" disabled class="form-control" value="<?php if($ut=="BA"||$ut=="FAC"||$ut=="EC")
...
<button class="btn btn-primary btn-rect "  type="submit" name="upbtn">UPDATE</button>
<button class="btn btn-primary btn-rect pull-right " type="submit" name="delbtn">ABORT</button>
</div>-->
</form>
<?php
