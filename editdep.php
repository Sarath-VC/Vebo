...
<div class="col-lg-12">
    <div class="box dark">
       <header>
            <div class="icons"><i class="">DEPARTMENT UPDATION</i></div>
            <h5><!-- .toolbar -->            </h5>
...
<button class="btn btn-primary " name="depreg" type="submit" onclick="return confirm('Are you sure want to confirm your updation !') ">UPDATE</button>
<button class="btn btn-primary pull-right " type="submit" onclick="disca();">DISCARD</button>
 ...
 <?php
               if(isset($_POST['depreg']))
               {
                ...
                $sql="update department set dept_name='$_POST[dep]' where dept_id=$u";
                ...
                ?>
<script type="text/javascript">alert("Successfully Updated");
