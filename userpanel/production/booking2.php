...
<div class="col-md-12 col-sm-12 col-xs-12" style="background-color:#e2e4ec;">
                <div class="x_panel">
                   ...
                   <h2><i class="glyphicon glyphicon-book"></i>  VENUE BOOKING FORM</h2>
        ...
        <div id="" class="body">
            <div class="form-horizontal">
               ...
               <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" required id="text1" placeholder="Event" class="form-control" name="ename">
                    </div>
               </div>
          ...
          include('connection.php');
            $sql1="select * from cart where cart_no=$car";
             $res1=mysql_query($sql1,$con);
             
             while($row1=mysql_fetch_assoc($res1))
             {
              $v=$row1['v_id'];
             $sql="Select * from venue where v_id=$v";
          ...
          ?>
               ...
               <!-- /.form-group -->
               <div class="form-group">
                    <label for="text2" class="control-label col-lg-4">Location</label>
                    <div class="col-lg-4">
                        <input type="text" required id="text2" name="loc" placeholder="Current Venue" class="form-control" value="<?php $i=0; foreach($que as  $value){ echo $value; $i++; } ?>">
                    </div>
               </div>
			   <!-- /.form-group -->
			   <div class="form-group">
...
if(isset($_POST['btns']))
      {
        ...
        if($rowu['password']==$_POST['pass'])
        {
                 ...
                 $sqlc1="select * from cart where cart_no=$car";
             ...
             while($rowc1=mysql_fetch_assoc($resc1)) {
              ...
              $v=$rowc1['v_id'];
                  ...
                  $datedet=$dateval2[1];
                  $flag=1;
                  $sqldat1="select * from cell where v_id=$v";
 ...
 if($flag==0){
                  ?><script>
                alert('Your are requested for a venue that has been already booked ');
                </script><?php
                }              
                   if($flag==1):
             ...
             $sqlc="Select * from venue where v_id=$v";
                 ...
                 { die('Error'.mysql_error($con)); }
                  ...
                  {
                     $q=$row['v_id'];
                      $sql1="insert into cell(cell_id,v_id,a_id,cell_status)values($cel,$q,0,'Requested')";
               ...
               $sql2="insert into bookingstatus(event_name,cell_id,bflag,purpose,reminder,start_date,start_time,finish_date,finish_time,user_id,ref_no)values('$_POST[ename]',$cel,1,'$_POST[des]','$_POST[rem]','$datedsd','$datedst','$dateded','$datedet',$u,'$ref')";
                $result2=mysql_query($sql2,$con);
              if(!$result2)
                 { die('Error'.mysql_error($con)); }
             else{
             	$sql="delete from cart where cart_no=$car";
