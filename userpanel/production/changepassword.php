        ...
        <div class="x_panel">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="password" required id="text1" placeholder="********" class="form-control" name="oldpass" />
                    </div>
                </div>
                ...
                <!-- /.form-group -->
                 <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="password" required pattern="[a-z0-9A-Z]{8,16}" id="newpass" placeholder="********" class="form-control" name="newpass" />
                    </div>
                </div>
                <div class="form-group">
...
if(isset($_POST['btn']))
{
  ...
  if($up==$row['password'])
  {
    ...
    if($res1)
    {
        ...
        window.location.assign("http://localhost/vebo/userpanel/production/userhome.php");</script>  <?php
    }
    else
    {
        echo mysql_error();
    ...
    ?>  <script type="text/javascript">alert("You were entered a wrong password !!");<?php
  }
}

?>
<script> function disca(){ window.location.assign("http://localhost/vebo/userpanel/production/userhome.php"); }</script>
	    </div>
	</div>
    </div>
        <!-- footer content -->
