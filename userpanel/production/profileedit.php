...
<div class="col-md-12 col-sm-12 col-xs-12" style="background-color:#e2e4ec;">
  ...
  $row2=mysql_fetch_assoc($res2);
    ...
    echo base64_encode($row1['exe_image']); else echo base64_encode($row1['stud_image']); ?>" width="132" height="170"/><div class="col-lg-12 ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <input type="text" required id="text1" placeholder="FIRST" class="form-control"value="<?php if($row['user_type']=="BA"||$row['user_type']=="FAC"||$row['user_type']=="EC")
  echo $row1['exe_fname']; else echo $row2['stud_fname']; ?>" name="fname">
                    </div>
                    <div class="col-lg-2">
                        <input type="text" required id="text2" placeholder="LAST" class="form-control" value="<?php if($row['user_type']=="BA"||$row['user_type']=="FAC"||$row['user_type']=="EC")
  echo $row1['exe_lname']; else echo $row2['stud_lname']; ?>" name="lname">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <select id="dept" class="form-control" name="dep"><option  
                        value="<?php if($ut=="FAC"||$ut=="EC") echo $row1['dept_id']; else echo $row2['dept_id']; ?>" required><?php  if($ut=="FAC"||$ut=="EC")
  echo $row1['dept_name']; else echo $row2['dept_name']; ?></option>
         ...
         <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                       <input type="date" required id="date2" name="dob" class="form-control" value="<?php if($ut=="FAC"||$ut=="EC")
  echo $row1['exe_dob']; else echo $row2['stud_dob']; ?>">
       ...
       $g=$row1['exe_gender']; else $g=$row2['stud_gender'];
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <textarea id="autosize" required class="form-control" name="add"><?php if($ut=="FAC"||$ut=="EC")
    {echo $row1['exe_address'];} else {echo $row2['stud_address'];} ?></textarea>
                ...
                <div class="form-group">
                     ...
                     <div class="col-lg-4">
                         <input type="text" required pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" id="email" placeholder="Email" class="form-control" value="<?php if($ut=="FAC"||$ut=="EC")
  echo $row1['exe_email']; else echo $row2['stud_email']; ?>" name="email">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="tel" required pattern="[0-9]{10}"  class="form-control" value="<?php if($ut=="FAC"||$ut=="EC")
...
if(isset($_POST['subbtn']))
{
    ...
    $res1=mysql_query($sql1,$con);
           if($res)
           {
            if($res1)
                {
                    ?> <script>alert("Updated successfully");window.location.assign("http://localhost/vebo/userpanel/production/profile.php");</script>  <?php
           ...
           if($res)
           {
            if($res1)
                {echo "<script>alert('Updated successfully');</script>";
                    ?> <script>window.location.assign("http://localhost/vebo/userpanel/production/profile.php");</script>  <?php
                 }
            else
                echo "<script>alert('Updated Partially');</script>";
           }
...
?><script>function disca() { window.location.assign("http://localhost/vebo/userpanel/production/profile.php"); }</script>
 </div>
