        ...
        <div id="" class="body">
            <div class="form-horizontal">
               ...
               <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" id="text2" name="loc" placeholder="Current Venue" class="form-control" value="<?php  echo $row['v_name'];  ?>">
                    </div>
               </div>
			   <!-- /.form-group -->
			   <div class="form-group">
        ...
        <div id="div-2" class="body">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" required value="<?php if($rowu['user_type']=="FAC"||$rowu['user_type']=="EC")
...
if(isset($_POST['btns']))
      {
        ...
        if($rowu['password']==$_POST['pass'])
        {
               ...
               else
               {
                   ...
                   if($flag==1)
                    {
                      $sql1="insert into cell(cell_id,v_id,a_id,cell_status)values($cel,$v,0,'Requested')";
